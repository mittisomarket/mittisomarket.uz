...
import { initialCustomers, initialProducts, initialSales } from './data';
...
function App() {
  ...
  const t = {
    uz_latn: { stat: "Statistika", main: "Asosiy", prod: "Mahsulotlar", cust: "Mijozlar", cash: "Kassa", sales: "Savdolar", feed: "Takliflar", set: "Sozlamalar", dealer: "Ish boshqaruvchi diler", tel: "Tel" },
  ...
  return (
    <>
      ...
      <div style={{paddingBottom: '2rem'}}>
        ...
        {tab === 'SAVDOLAR' && (
          <Savdolar sales={sales} products={products} customers={customers} onAddSale={handleAddSale} />
        )}
